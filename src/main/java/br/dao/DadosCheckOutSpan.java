...
public class DadosCheckOutSpan {
...
public Object busca(String cnpj) {
	ArrayList<DadosHospedagem> hospedagem = new ArrayList<DadosHospedagem>();
		...
		try{
			...
			System.out.println("vai buscar os checkouts de hoje");
			...
			System.out.println("tudo OK ... retornando a lista com checkouts a ser realizados");
			
		}catch(Exception e){
			System.out.println("CATCH em Object busca(String cnpj) em DAO DadosCheckOutSpan ...");
			e.printStackTrace();
		}
...
ArrayList<DadosHospedagem> hospedagem = new ArrayList<DadosHospedagem>();
	...
	public boolean realizacheckout(String cnpj, DadosHospedagem dados) {
		Connection c = null;
		...
		try {
			...
			c = Conexao.getConexao(cnpj);//conecta na base de dados criada
				...
				sql = "UPDATE hospedagem SET xout  = 1 where codhospedagem = "+dados.getCodhospedagem()+";";
				
				stmt = c.prepareStatement(sql);	
				
				stmt.execute();
				
				sql = "UPDATE quarto SET disponivel  = 1 where codquarto = "+dados.getCodquarto()+" ;";
				
				stmt = c.prepareStatement(sql);	
				
				stmt.execute();
				
				System.out.println(".........check-out OK, stmt.close e voltando....");
			...
			e.printStackTrace();
			System.out.println("......... ERRO EM realizacheckout(String cnpj, DadosHospedagem dados).............");
			return retorno;
		}	
