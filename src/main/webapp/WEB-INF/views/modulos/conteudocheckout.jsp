<div class="col-md-9">
	<div class="row">
		<div class="col-md-10 text-center">
			<h2 style="font-family: 'Yanone Kaffeesatz', sans-serif;">CHECK-OUT a ser feito hoje ${numeros.data} -(${numeros.saida})</h2>
		</div>
	</div>
	<br><br>
	<div class="row">
		<div class="col-md-5 col-md-offset-5">
			<div class="input-group">
				<form action="spancheckoutbusca" method="post">
					...
					<tbody>
						...
						<c:forEach var="x" items="${xout}">
							<tr class="text-center">
								...
								<td>
									<a class="btn btn-success" title="REALIZAR CHECK-OUT"
										href="fazercheckout?codhospedagem=${x.codhospedagem}&codquarto=${x.codquarto}">
